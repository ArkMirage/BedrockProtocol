...
namespace Protocol.Connection
{
	public enum DisconnectFailReason
	{
		...
		LegacyDisconnect = 13,
		/// <summary>INTERNAL_UserLeaveGameAttempted</summary>
		...
		/// <summary>TESTONLY_CantConnect</summary>
		...
		/// <summary>INTERNAL_NoFailOccurred</summary>
		...
		/// <summary>INTERNAL_RequestServerShutdown</summary>
